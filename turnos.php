...
// Si no hay una sesión activa, lo pateamos al index (login)
...
<div class="container py-4 px-lg-4">
    ...
    <div class="row mb-4 animate__animated animate__fadeInDown">
        <div class="col-12 d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom" style="border-color: var(--borde) !important;">
            
            <h3 class="fw-bold m-0"><i class="bi bi-scissors text-primary me-2"></i>Estilo Único</h3>
            
            <div class="d-flex align-items-center gap-3">
                <button id="btn-tema" onclick="toggleTema()" title="Cambiar Tema" class="btn btn-outline-secondary rounded-circle p-0 d-flex align-items-center justify-content-center" style="width: 38px; height: 38px; border-color: var(--borde);">
                    <i class="bi bi-sun-fill" id="icono-tema" style="color: var(--texto-principal);"></i>
                </button>

                <span class="fw-bold d-none d-md-block ps-2" style="color: var(--texto-principal);">
                    <i class="bi bi-person-circle me-1 text-primary"></i> <?php echo $_SESSION['nombre']; ?>
                </span>

                <?php if($_SESSION['rol'] == 'admin'): ?>
                    <a href="admin.php" class="btn btn-primary btn-sm rounded-pill px-3 fw-bold">
                ...
                <div class="mb-3">
                    ...
                    <select id="servicio" class="form-select">
                        ...
                        while($s = mysqli_fetch_assoc($query_s)){
                            $precio_f = number_format($s['precio'], 0, ',', '.');
                            echo "<option value='{$s['nombre']}'>{$s['nombre']} - $$precio_f</option>";
                        }
                        ?>
                    </select>
                </div>
...
<script>
    // --- Lógica del Tema para turnos.php ---
